...
export const metadata: Metadata = {
  title: "FlashLearn - Master Japanese with Spaced Repetition",
  description: "Learn Japanese faster with scientifically-proven spaced repetition and the SuperMemo 2 algorithm.",
  generator: "v0.app",
  icons: {
    icon: [
      {
